...
from utils import show_image, resize_and_pad, select_device
import argparse
...
def inference(model_path, data_dir, output_dir, imgsz):
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='infer with a pretrained model')
...
def main():
    ...
    imgsz = args.imgsz
    inference(model_path, data_dir, output_dir, (imgsz, imgsz))
